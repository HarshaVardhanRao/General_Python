...
root = Tk()
root.title('HarshaVardhan To-Do List')
root.geometry('300x400')
root.resizable(0, 0)
root.config(bg="VioletRed")

# Heading Label
Label(root, text='HarshaVardhan To-Do List', bg='VioletRed', font=("Comic Sans MS", 15), wraplength=300).place(
    x=35, y=0)
